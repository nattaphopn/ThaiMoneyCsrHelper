...
function App() {
  ...
  return (
    <c.Box bgColor="#f5f5f5e8" w={window.innerWidth} h={window.innerHeight} mt="-20px">
      <c.Box m="20px" p="10px" bgColor="#ffffffff" borderRadius="20px">
        <c.HStack>
        ...
        <c.HStack maxW={window.innerWidth}>
          <c.Box w="200px">
            <c.Text fontFamily="Noto Sans Thai" fontSize="14px" fontWeight="400" align="center" lineHeight="5px">ก่อนหน้า</c.Text>
            <c.Text fontFamily="roboto" fontSize="20px" fontWeight="500" align="center" lineHeight="5px">{rate}</c.Text>
            <c.Text fontFamily="Noto Sans Thai" fontSize="12px" fontWeight="400" align="center" lineHeight="5px">{date.replace(/\s+/g, ' ')}</c.Text>
          </c.Box>
          <c.Box w="200px">
            <c.Text fontFamily="Noto Sans Thai" fontSize="14px" fontWeight="400" align="center" lineHeight="5px">ปัจจุบัน</c.Text>
            <c.Text fontFamily="roboto" fontSize="20px" fontWeight="500" align="center" lineHeight="5px" color={GAPROUNDED-rate < 0 ? "#be2116ff" : (GAPROUNDED-rate > 0 ? "#4ac573ff" : "")} id="GAP ROUNDED2">{GAPROUNDED} {GAPROUNDED-rate < 0 ? "▼" : (GAPROUNDED-rate > 0 ? "▲" : "")}</c.Text>
            <c.Text fontFamily="Noto Sans Thai" fontSize="12px" fontWeight="400" align="center" lineHeight="5px">{UPDATE.replace(/\s+/g, ' ')}</c.Text>
          </c.Box>
        </c.HStack>
      </c.Box>
    </c.Box>
